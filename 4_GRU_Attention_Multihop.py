...
x2 = Attention(x2,input_dim,time_steps,SINGLE_ATTENTION_VECTOR)
x2 = Attention()(x2)
...
x3 = GRU(128, return_sequences=True, activation='tanh')(embedded_input3)
x3 = Dropout(0.2)(x3)
...
filepath="models/4_GRU_Attention_Multihop_loss_{loss:.4f}-acc_{acc:.4f}-vloss_{val_loss:.4f}-vacc_{val_acc:.4f}.hdf5"
checkpoint = ModelCheckpoint(filepath, monitor='val_loss', verbose=1, save_best_only=True, mode='auto')
callbacks_list = [checkpoint]

print model.summary()
#plot_model(model, to_file='plot/4_GRU_Attention_Multihop.png', show_shapes=True, show_layer_names=False)
